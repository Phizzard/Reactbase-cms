        ...
        return(
            <div className="row">
                ...
                <main className="col-sm-9 ml-sm-auto col-md-10 pt-3" role="main">
                    ...
                    <EditRecordForm contentId={this.props.match.params.contentId} formattedId={formattedId} data={this.state.data} contentId={this.props.match.params.contentId} recordId={this.props.match.params.recordId} />
                </main>
            </div>
        );
    }
